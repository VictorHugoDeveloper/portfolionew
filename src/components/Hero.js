...
import PerfilImage from "../assets/perfil_image.jpeg"
...
export default function Header({ color }) {
  ...
  const imageStyle = {
    width: '100%',
    height: '100%',
    borderRadius: '50%', // Faz a borda arredondada
    objectFit: 'cover', // Ajusta a imagem para cobrir o contêiner
    border: '2px solid #ddd', // Opcional: adiciona uma borda ao redor da imagem
  };
  return (
    <>
      <Heading>
